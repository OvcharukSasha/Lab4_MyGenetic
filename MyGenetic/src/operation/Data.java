...
public class Data {
	...
	private Data initialize() {
		...
		Group group1 = new Group("ТТП-41", new ArrayList<Course>(Arrays.asList(course1, course3)));
		...
		Group group4 = new Group("ТТП-42", new ArrayList<Course>(Arrays.asList(course1, course3)));
